          ...
          <table class="purchases"
            ...
            <tr class="goods-list" v-for="(item,idx2) in apply.prod_list" :key="idx2">
              <td class="goods">
                ...
                <div class="r font14"><span class="danger-color">￥<span
                  class="price-num font18">{{item.prod_price}}</span></span></div>
              </td>
              <td class="price-box" v-if="idx2===0" :rowspan="apply.prod_list.length">
                <div class="text-center">
                  <div class="total line6">总计:<span class="danger-color">￥<span
                    class="total_num font18">{{apply.price}}</span></span></div>
              ...
              <td class="actions text-center" v-if="idx2===0" :rowspan="apply.prod_list.length">
                ...
                <div class="line10" v-if="inArray(apply.status,[35])">
                  ...
                  >
                    ...
                    <el-button slot="reference" size="small" @click.prevent="apply.checkVisible = true"
                               class="acion-btn" type="success">取消
                    </el-button>
                  </el-popover>
                ...
                <div class="line10" v-if="inArray(apply.status,[31])">
                  ...
                  >
                    ...
                    <el-button slot="reference" size="small" @click.prevent="apply.cancelVisible = true"
                               class="acion-btn" type="danger">取消
                    </el-button>
                  </el-popover>
                ...
                <div class="line10" v-if="inArray(apply.status,[32])">
                  ...
                  >
                    ...
                    <el-button slot="reference" size="small" @click.prevent="apply.sendVisible = true" class="acion-btn"
                               type="primary">发货
                    </el-button>
                  </el-popover>
                </div>
                <div @click="showLogistics(apply)" v-if="apply.Order_ShippingID && inArray(apply.status,[34,35,36])"
                     class="font12 graytext2 logistics">查看物流
                </div>
              </td>
            </tr>
          </table>
      ...
      <div class="dialog-container">
        ...
        <div class="row">
          ...
          <div class="text">
            ...
            <a v-if="storeDialogInstance.info.open" target="_blank" :href="storeDialogInstance.info.open"><i
              style="font-size: 20px;color:#F43131;" class="el-icon-location"/></a>
          </div>
        </div>
      </div>
  ...
  export default class StorePurchaseApply extends Vue {
    ...
    openSendDialog(apply, idx) {
      ...
      if (this.sendDialogInstance.express_list.length < 1) {
        ...
        getShippingListByStore().then(res => {
    ...
    changeApplyChannel() {
      ...
      let postData = {
        ...
        order_id: this.channelDialogInstance.apply.Order_ID
      }
