<template>
  <div @click.stop="setData({}, 0)" class="flash wrap" id="goods"
       :style="{paddingLeft:goods.style.wrapmargin+'px',paddingRight:goods.style.wrapmargin+'px',background:goods.style.bgColor}">
