...
<!--        &lt;!&ndash;        <img src="@/assets/img/icon-del.png" class="delicon" />&ndash;&gt;-->
<!--        <i class="el-icon-error delicon" @click="delArea(area)"/>-->
<!--        &lt;!&ndash;        <svg class="fun-icon icon delicon" @click="delArea(area)" aria-hidden="true">&ndash;&gt;-->
<!--        &lt;!&ndash;          <use xlink:href="#icon-del"></use>&ndash;&gt;-->
<!--        &lt;!&ndash;        </svg>&ndash;&gt;-->
<!--      </div>-->
