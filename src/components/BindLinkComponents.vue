...
<script>
// import {category, subject, topic} from '@/assets/js/fetch/index'
...
//                     this.innerDialog.classify.data = res.rows
//                 })
//             }
...
//                         v.text = `[课程] ${v.title}`;
//                         v.path = `/subject/courseDetail?id=${v.id}`;
//                         v.type = 'subject';
//                         return v
//                     });
...
//                     let data = res.rows.map(v => {
//                         v.text = `[专栏] ${v.title}`;
//                         v.path = `/subject/columnDetail?id=${v.id}&subject_ids=${v.subject_ids}`;
//                         v.type = 'topic';
//                         return v
//                     });
//                     this.innerDialog.product.data.push(...data)
...
//                         path = `/subject?classId=${data.id}`;
//                         tooltip = `分类：${data.name}`;
//                         dataItem = data;
//                         break;
//                     case '3':
