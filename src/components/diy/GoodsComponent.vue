...
import de from 'element-ui/src/locale/lang/de';
    ...
    @Component({
      ...
      computed: {
          ...
          w(){
            return document.getElementById('goods').offsetWidth;
          },
          itemw(){
              let full = document.getElementById('goods').offsetWidth;
      ...
      methods: {
        itemMarginObj(idx){
            ...
            // {marginBottom:goods.style.margin+'px',marginLeft:idx%2==0?goods.style.margin:goods.style.margin/2+'px',marginRight:idx%2==0?goods.style.margin/2:goods.style.margin+'px'}
